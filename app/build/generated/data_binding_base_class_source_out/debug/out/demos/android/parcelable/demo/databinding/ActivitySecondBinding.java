...
package demos.android.parcelable.demo.databinding;
...
import demos.android.parcelable.demo.R;
...
public final class ActivitySecondBinding implements ViewBinding {
  ...
  private ActivitySecondBinding(@NonNull LinearLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivitySecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySecondBinding((LinearLayout) rootView, textView);
    }
